...
export declare type CreatePersistence<T = Int8Array, B = Buffer> = (params: PersistenceParams<B>) => Persistence<T>;
...
export declare type CreatePersistenceAdapter<K = Buffer, V = Buffer> = (params: PersistenceAdapterParams) => PersistenceAdapter<K, V>;
